...
<Flex><Text>QuickView Options: check the boxes below to load other pages you wish to display or uncheck to hide the pages.</Text></Flex>
<Flex     pt={10}    ><Button             borderRadius={50} colorScheme='gray'   mr={5}   >Select All </Button>   <Checkbox   mr={5}     >Basic</Checkbox>    <Checkbox>Premiums</Checkbox>     </Flex>
...
<Flex     pt={10}    >   <Checkbox   mr={5}     >MTC</Checkbox>    <Checkbox    defaultChecked>APD</Checkbox>     </Flex>
                                                
                                                 </Flex>
                                            <Flex>
                                                
                                            <HStack      pt={10}  w={"100%"}  justifyContent={"space-between"}   >
...
<Flex pl={10}  >
                                                ...
                                                <Text>Signed application received (Logs)</Text>
                                                <RadioGroup pr={10} >


      <Radio value='Sasuke'>NO</Radio>
      <Radio value='Nagato'>Yes </Radio>
                                                </RadioGroup>
</Flex>
